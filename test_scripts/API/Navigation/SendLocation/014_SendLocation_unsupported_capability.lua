...
--[[ Local Functions ]]
local function disableSendLocationCapability()
  local params = hmi_values.getDefaultHMITable()
  params.UI.GetCapabilities.params.systemCapabilities.navigationCapability.sendLocationEnabled = false
  return params
end
...
runner.Step("Start SDL, HMI, connect Mobile, start Session", commonSendLocation.start, {disableSendLocationCapability()})
